//
//  BounceEffectViewController.swift
//  McccSymbols_Example
//
...
class BounceEffectViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        // 第1个：整个符号跳动，慢速0.5，循环
        imageView1.addSymbolEffect(.bounce.wholeSymbol, options: .speed(0.5))
        
        // 第2个：按每个层分别向下跳动，正常速度，循环
        imageView2.addSymbolEffect(.bounce.byLayer.up, options: .repeating.speed(0.1) )
        
        // 第3个：按每个层分别向上跳动，正常速度，循环
        imageView3.addSymbolEffect(.bounce.up.byLayer, options: .repeating)
    }
